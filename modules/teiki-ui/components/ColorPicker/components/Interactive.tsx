// Clone from https://github.com/omgovich/react-colorful/blob/master/src/components/common/Interactive.tsx
// TODO: replace this component with teiki-ui slider
...
const InteractiveBase = ({ onMove, onKey, className, ...rest }: Props) => {
  ...
  const [handleMoveStart, handleKeyDown, toggleDocumentEvents] = useMemo(() => {
    const handleMoveStart = ({
      ...
      el.focus();
      onMove(getRelativePosition(el, nativeEvent, touchId.current));
