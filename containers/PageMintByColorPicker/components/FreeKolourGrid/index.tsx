// A duplicate of "containers/PageKolours/containers/ModalFreeMintKolour/container/FreeKolourGrid/index.tsx"
            ...
            <>
              <Flex.Col className={styles.card}>
                ...
                <Flex.Row alignItems="center" gap="12px" padding="16px 24px">
                  {/* For the Free mint programme, the listed fee would be the orignal price, while the fee is, of course, 0.
                      This "hardcode" helps to reduce the number of requests to BE.
                  */}
                  <Typography.Span
