...
export default function ProjectThumbnail({
  ...
  const actualCoverImage = coverImages[0] || DEFAULT_IMAGE;
  const actualLogoImage = logoImage || DEFAULT_IMAGE;
  return (
    <div className={cx(styles.container, className)} style={style}>
      ...
      <div className={styles.logoImageContainer}>
        <ImageView
          ...
          src={actualLogoImage.url}
          crop={actualLogoImage.crop}
        />
      </div>
      {!match ? null : (
        <Typography.Div
