export default function IconImage() {
  return (
    ...
    >
      ...
      />
      <path
        d="M3 16.9999L8.22999 10.8983C8.63274 10.4284 9.36128 10.4335 9.75746 10.9089L13.299 15.1587C13.6754 15.6104 14.3585 15.6414 14.7743 15.2256L16.21 13.79C16.6314 13.3685 17.3256 13.407 17.698 13.8724L21 17.9999"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
